  ...
  const fetchCourses = async () => {
    ...
    if (error) {
      ...
      const coursesWithContent = data.map((course) => {
        ...
        //   course.imageUrl = '/logoReact.png';
        //   course.videos = [
        switch (course.title) {
          case "React for Beginners":
            course.imageUrl = "/logoReact.png";
            course.videos = [
              {
            ...
            //   course.imageUrl = '/logoNodejs.png';
            //   course.videos = [
            break;
          case "Advanced Node.js":
            course.imageUrl = "/logoNodejs.png";
            course.videos = [
              {
          ...
          case "CSS Mastery":
            ...
            //   course.imageUrl = '/logoJavascript.jpeg';
            //   course.videos = [
            break;
          case "JavaScript":
            course.imageUrl = "/logoJavascript.jpeg";
            ...
            //   course.imageUrl = '/logoFullstack.png';
            //   course.videos = [
            break;
          case "Full Stack Development":
            ...
            //   course.imageUrl = '/logoPython.jpg';
            //   course.videos = [
            break;
          case "Introduction to Python":
            ...
            //   course.imageUrl = '/logoGit.jpg';
            //   course.videos = [
            break;
          case "Mastering Git & GitHub":
            course.imageUrl = "/logoGit.jpg";
            course.videos = [
              {
          ...
          default:
            course.imageUrl = "/defaultImage.png";
            course.videos = [{ title: "Default Course Content", link: "#" }];
        }
        return course;
      });
              ...
              <ul className="space-y-4">
                {selectedCourse.videos.map((video, index) => (
                  ...
                  >
                    ...
                    >
                      <span className="bg-green-400 text-white p-2 rounded-full">
                        {index + 1}
                      </span>
